import { ProgramFeatures, WhyChooseMindery } from "../types/data";
  ...
  return (
    <div className="mb-[4rem]">
      <div>
        ...
        <p>Pick a track or mix and match. Each program grows withs child.</p>
      </div>
        ...
        <div className="flex flex-col justify-between">
          <table>
            <thead className="bg-fuchsia-100/40">
              <tr>
                <th className="border border-zinc-300/50 px-4 py-2">Features</th>
